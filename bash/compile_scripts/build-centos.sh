...
sudo dnf update -y
sudo dnf install jq sshfs cmake fribidi-devel git jansson-devel numactl-devel python2 python3 opus-devel xz-devel lame-devel libogg-devel libsamplerate-devel libtheora-devel libvpx-devel libvorbis-devel meson nasm ninja-build opus-devel speex-devel libass-devel x264 x264-devel ffmpeg rhash mc nano htop screen libvpx-devel libxml2-devel numactl -y
# Build handbrake
