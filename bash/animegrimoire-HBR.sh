...
preset="/home/$USER/.local/preset/x264_Animegrimoire_HBR.json"
...
sed '/Format\: Layer/a Dialogue\: 0,0:00:00.00,0:00:30.00,Watermark,,0000,0000,0000,,animegrimoire.station.moe' "modified_sub.tmp1" > "$subtitle"
